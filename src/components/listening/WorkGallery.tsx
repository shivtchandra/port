...
export const FLAGSHIP_SLUGS = ["resumit", "cybersealtrain", "golden-hour", "drivescope", "mapping-hyd"];
export function WorkGallery() {
  ...
  return <section id="selected-work" className="work-gallery">
    <div className="gallery-heading"><p className="room-eyebrow">Side A / Selected work</p><h2>Made to be used.<br /><em>Worth a closer look.</em></h2><p>AI products, client platforms, city maps, car decisions, and a pocket film camera.<br />Different problems. Full ownership.</p></div>
