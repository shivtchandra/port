  ...
  return (
    <>
      <svg viewBox="0 0 320 290" aria-hidden>
        ...
        <path d="M57 183V133C57 5 263 5 263 133V183" fill="none" stroke="url(#hp-metal)" strokeWidth="19" />
        ...
        <g transform="rotate(-12 64 191)">
          <rect x="33" y="141" width="51" height="100" rx="23" fill="url(#hp-metal)" />
          <rect x="62" y="135" width="38" height="112" rx="18" fill="url(#hp-pad)" stroke="#68735e" strokeWidth="2" />
          <path d="M76 147V235" stroke="#88957a" strokeWidth="2" opacity=".4" />
        </g>
        <g transform="rotate(12 258 191)">
          <rect x="235" y="141" width="51" height="100" rx="23" fill="url(#hp-metal)" />
          <rect x="220" y="135" width="38" height="112" rx="18" fill="url(#hp-pad)" stroke="#68735e" strokeWidth="2" />
  ...
  return (
    <section className="personal-opening" id="hero">
      ...
      <div className="opening-stage" ref={stage}>
        {/* Clean central narrative block */}
        <div className="opening-center">
          <p className="opening-hello">
            <span className="name-pill">Hey — I’m <strong>Shiva</strong></span>
          </p>
          ...
          <div className="opening-actions">
            <a className="room-button" href="#selected-work">
        ...
        {/* Floating Interactive Objects (Uncluttered & Spatially Separated) */}
        <motion.a
          className="headphone-object sticker-drag sticker-headphones"
          href="#music-corner"
          aria-label="Open my music corner in Side B"
          draggable={false}
          style={{ rotate: reduced ? 0 : 12, zIndex: 6 }}
          {...sharedDrag}
        ...
        <motion.a
          ...
          draggable={false}
          style={{ rotate: reduced ? 0 : -6, zIndex: 7 }}
          {...sharedDrag}
          onClick={(event) => { suppressIfDragged(event); }}
        >
        ...
        <motion.button
          ...
          style={{ zIndex: 8 }}
          {...sharedDrag}
          animate={{ rotate: reduced ? 0 : flipped ? -3 : 4 }}
