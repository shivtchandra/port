...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      "XGBoost quantile regression on MIMIC-IV to predict hospital stays and costs — Flask API + React front end.",
    outcome: "430K+ patient records",
    role: "ML · Full-stack",
    impact: "430K+ patient records",
